...
scoreWrongAnswer_NR = 0* scoreScale
scoreCorrectAnswer_NR = 1.0* scoreScale
scoreBlankAnswer_NR = 0* scoreScale

scoreWrongAnswer_PS = 0* scoreScale
scoreCorrectAnswer_PS = 1.0* scoreScale
scoreBlankAnswer_PS = 1.0/(numberAlternatives-1)* scoreScale

scoreWrongAnswer_FS = -1.0/(numberAlternatives-1)* scoreScale
scoreCorrectAnswer_FS = 1.0* scoreScale
scoreBlankAnswer_FS = 0* scoreScale

scoreWrongAnswer_ET = -1* scoreScale
scoreCorrectAnswer_ET = 1.0/(numberAlternatives-1* scoreScale)
